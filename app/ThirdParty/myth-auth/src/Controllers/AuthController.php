...
class AuthController extends Controller
{
	...
	public function attemptLogin()
	{
		...
		return redirect()->to($redirectURL)->withCookies()->with('message', "Welcome back, " . user()->username . "!");
	}
	...
	{
		if (!$this->config->activeResetter || logged_in()) {
	...
	public function attemptForgot()
	{
		...
		return redirect()->route('reset-password')->with('info', lang('Auth.forgotEmailSent'));
	}
